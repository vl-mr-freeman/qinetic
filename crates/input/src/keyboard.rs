...
///     .with_system(InputStage::default(), KeyboardSystem::default())
///     .build()
///     .unwrap();
/// ```
...
impl KeyboardEvent {
    /// Returns a [`KeyboardEventBuilder`] with `default` configuration.
    ///
    /// # Examples
    /// ```
    /// # use qinetic_input::prelude::*;
...
/// The `scancode` of a [`KeyboardEvent`].
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq, PartialOrd, Ord, CopyGetters)]
#[getset(get_copy = "pub")]
pub struct ScanCode {
    scancode: u32,
}
...
impl ScanCode {
    /// Returns a [`ScanCode`] with `scancode`.
    ///
    /// # Examples
    /// ```
    /// # use qinetic_input::prelude::*;
